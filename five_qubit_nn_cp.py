...
from bqskit.ir.gates import CCXGate, CXGate, RZZGate, RXXGate, RYYGate, CZGate, CPGate
...
if __name__ == '__main__':
    ...
    target_circuit.append_gate(CPGate(), (0, 4))
    target_unitary = target_circuit.get_unitary([np.pi/4])
