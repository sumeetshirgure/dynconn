...
from bqskit.ir.gates import CXGate, RZZGate, RXXGate, RYYGate, CZGate, SwapGate
...
if __name__ == '__main__':
    ...
    target_circuit.append_gate(SwapGate(), (0, 2))
    ...
    # Branch circuits
    ancillas = [1] # we put mid-circuit measurement on q1 and q2
    ...
    branch_circuits = [branch_0, branch_1]
